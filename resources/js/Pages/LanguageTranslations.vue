<template>
    <div class="bg-white shadow-lg rounded-lg border-2">
        <table class="w-full mt-4 text-gray-700">
            <thead class="border">
                <tr >
                    <th class="text-center p-2 w-12 border-r">Translated</th>
                    <th class="text-left p-2 border-l p-2 w-1/6">File</th>
                    <th class="text-left p-2 border-l p-2  ">Keys</th>
                    <th class="text-left p-2 border-l p-2  w-1/4">Source</th>
                        ...
                        <i
                            :class="
                                translation.translated
                                    ? 'pi pi-check text-green-500 bg-green-100 p-1 rounded-full'
                                    : 'pi pi-times text-red-500 bg-red-100 p-1 rounded-full'
                            "
                        />
                    </td>
                    <td class="p-4 border-r">{{ translation.file }}</td>
                    <td class="p-4 border-r">{{ translation.key }}</td>
                    <td class="p-4 border-r ">{{ translation.source }}</td>
                    <td class="p-4 border-r">{{ translation.value }}</td>
                    <td class="hover:bg-indigo-100"><Link :href="route('ltm.translations.edit', [lang, translation])" class="p-4 hover:bg-indigo-100"><i class="pi pi-pencil" /></Link></td>
